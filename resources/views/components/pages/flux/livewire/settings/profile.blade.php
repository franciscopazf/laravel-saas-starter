<section class="w-full">
    <x-pages.flux.components.settings.layout :heading="__('Profile')" :subheading="__('Update your name and email address')">
        ...
        <livewire:universal.settings.delete-user-form />
